...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc -shared -Wl,-O1 -Wl,--sort-common -Wl,--as-needed '
              '-Wl,-z,relro -Wl,-z,now          -Wl,-z,pack-relative-relocs '
              '-flto=auto -Wl,-O1 -Wl,--sort-common -Wl,--as-needed '
              '-Wl,-z,relro -Wl,-z,now          -Wl,-z,pack-relative-relocs '
              '-flto=auto',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 ...
 'CC': 'gcc',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=x86-64 -mtune=generic -O2 '
           ...
           '-ffile-prefix-map=/home/darren/.cache/yay/python311/src=/usr/src/debug/python311 '
           '-flto=auto -fno-semantic-interposition -march=x86-64 '
           ...
           '-fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -g '
           '-ffile-prefix-map=/home/darren/.cache/yay/python311/src=/usr/src/debug/python311 '
           '-flto=auto -fno-semantic-interposition',
 'CFLAGSFORSHARED': '-fPIC',
 'CFLAGS_ALIASING': '',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-march=x86-64 -mtune=generic -O2 -pipe -fno-plt '
 ...
 'CONFIGURE_CFLAGS_NODIST': '-flto -fuse-linker-plugin -ffat-lto-objects '
                            '-flto-partition=none -g -std=c11 '
                            '-Werror=implicit-function-declaration '
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,-O1 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
 ...
 'CONFIG_ARGS': "'ax_cv_c_float_words_bigendian=no' '--prefix=/usr' "
                "'--enable-shared' '--with-computed-gotos' '--with-lto' "
                "'--enable-ipv6' '--with-system-expat' "
                "'--with-dbmliborder=gdbm:ndbm' '--with-system-ffi' "
                "'--with-system-libmpdec' "
                "'--enable-loadable-sqlite-extensions' '--without-ensurepip' "
                "'--with-tzpath=/usr/share/zoneinfo' 'CFLAGS=-march=x86-64 "
                '-mtune=generic -O2 -pipe -fno-plt -fexceptions         '
                ...
                '-mno-omit-leaf-frame-pointer -g '
                '-ffile-prefix-map=/home/darren/.cache/yay/python311/src=/usr/src/debug/python311 '
                "-flto=auto -fno-semantic-interposition' 'LDFLAGS=-Wl,-O1 "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/darren/.cache/yay/python311/src/Python-3.11.11/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/darren/.cache/yay/python311/src/Python-3.11.11/lcov-report',
 ...
 'DESTDIRS': '/usr /usr/lib /usr/lib/python3.11 '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -shared -Wl,-O1 -Wl,--sort-common -Wl,--as-needed '
             '-Wl,-z,relro -Wl,-z,now          -Wl,-z,pack-relative-relocs '
             '-flto=auto -Wl,-O1 -Wl,--sort-common -Wl,--as-needed '
             '-Wl,-z,relro -Wl,-z,now          -Wl,-z,pack-relative-relocs '
             '-flto=auto',
 ...
 'LIBEXPAT_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=x86-64 '
                    '-mtune=generic -O2 -pipe -fno-plt -fexceptions         '
                    '-Wp,-D_FORTIFY_SOURCE=3 -Wformat '
                    '-Werror=format-security         -fstack-clash-protection '
                    '-fcf-protection         -fno-omit-frame-pointer '
                    ...
                    '-mno-omit-leaf-frame-pointer -g '
                    '-ffile-prefix-map=/home/darren/.cache/yay/python311/src=/usr/src/debug/python311 '
                    '-flto=auto -fno-semantic-interposition -flto '
 ...
 'LIBMPDEC_CFLAGS': '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -DNDEBUG -g '
                    '-fwrapv -O3 -Wall -march=x86-64 -mtune=generic -O2 -pipe '
                    '-fno-plt -fexceptions         -Wp,-D_FORTIFY_SOURCE=3 '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=x86-64 '
                             '-mtune=generic -O2 -pipe -fno-plt '
                             '-fexceptions         -Wp,-D_FORTIFY_SOURCE=3 '
                             '-Wformat -Werror=format-security         '
                             '-fstack-clash-protection -fcf-protection         '
 ...
 'PY_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=x86-64 -mtune=generic -O2 '
              '-pipe -fno-plt -fexceptions         -Wp,-D_FORTIFY_SOURCE=3 '
              '-Wformat -Werror=format-security         '
              '-fstack-clash-protection -fcf-protection         '
              '-fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -g '
 ...
 'PY_CORE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=x86-64 -mtune=generic '
                   ...
                   '-fvisibility=hidden  -I./Include/internal -I. -I./Include '
                   '-fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,-O1 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                    '-Wl,-z,now          -Wl,-z,pack-relative-relocs '
                    '-flto=auto -Wl,-O1 -Wl,--sort-common -Wl,--as-needed '
                    '-Wl,-z,relro -Wl,-z,now          '
                    '-Wl,-z,pack-relative-relocs -flto=auto -flto '
                    '-fuse-linker-plugin -ffat-lto-objects '
                    '-flto-partition=none -g',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-O1 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
               '-Wl,-z,now          -Wl,-z,pack-relative-relocs -flto=auto '
               '-Wl,-O1 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
               '-Wl,-z,now          -Wl,-z,pack-relative-relocs -flto=auto',
 'PY_LDFLAGS_NODIST': '-flto -fuse-linker-plugin -ffat-lto-objects '
                      '-flto-partition=none -g',
 'PY_LDFLAGS_NOLTO': '-Wl,-O1 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                     '-Wl,-z,now          -Wl,-z,pack-relative-relocs '
                     '-flto=auto -Wl,-O1 -Wl,--sort-common -Wl,--as-needed '
                     '-Wl,-z,relro -Wl,-z,now          '
                     '-Wl,-z,pack-relative-relocs -flto=auto -fno-lto',
 'PY_SQLITE_ENABLE_LOAD_EXTENSION': 1,
 'PY_SQLITE_HAVE_SERIALIZE': 1,
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=x86-64 '
                        '-mtune=generic -O2 -pipe -fno-plt '
                        '-fexceptions         -Wp,-D_FORTIFY_SOURCE=3 -Wformat '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/darren/.cache/yay/python311/src/Python-3.11.11',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/darren/.cache/yay/python311/src/Python-3.11.11 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/darren/.cache/yay/python311/src/Python-3.11.11 '
 ...
 'abs_builddir': '/home/darren/.cache/yay/python311/src/Python-3.11.11',
 'abs_srcdir': '/home/darren/.cache/yay/python311/src/Python-3.11.11',
